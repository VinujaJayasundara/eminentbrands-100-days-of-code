...
function getWeatherData(city) {
    return __awaiter(this, void 0, void 0, function () {
        var apiKey, url, response, data, error_1;
...
function updateUI(data) {
    console.log("The temperature in ".concat(data.name, " is ").concat(data.main.temp, "\u00B0C"));
}
// Testing the logic
getWeatherData("London").then(function (data) {
    if (data)
        updateUI(data);
});
